...
class RuleController {
    ...
    static async rate(req, res) {
      try{
        ...
        if (!rule ) return res.status(400).json({
        ...
        if (typeof rule !== "object") return res.status(400).json({
          message: "rule should be an object.",
          status: "error",
          data: null
        })
        if (typeof data !== "object") return res.status(400).json({
        ...
        } else if (rule.condition === "eq"  && newValue !== rule.condition_value){
           return  res.status(400).json({
        ...
        } else if (rule.condition === "contains"  && newValue !== rule.condition_value){
           return  res.status(400).json({
            message: `field ${rule.field} failed validation.`,
            status: "failed",
            data: {
        ...
        } else if (rule.condition === "neq" && newValue === rule.condition_value){
           return  res.status(400).json({
            message: `field ${rule.field} failed validation.`,
            status: "failed",
            data: {
        ...
        } else if(rule.condition === "gt" && newValue < rule.condition_value){
           return  res.status(400).json({
            message: `field ${rule.field} failed validation.`,
            status: "failed",
            data: {
        ...
        } else if (rule.condition === "gte" && newValue <= rule.condition_value){
           return  res.status(400).json({
            message: `field ${rule.field} failed validation.`,
            status: "failed",
            data: {
